...
const stats = [
  ...
  { label: "Registered Users", value: 4, color: "bg-purple-100", textColor: "text-purple-600", icon: "👥" },
  { label: "Total Organizations", value: 9, color: "bg-blue-100", textColor: "text-blue-700", icon: "🏢" },
  ...
  { label: "System Alerts", value: 1, color: "bg-red-400", textColor: "text-white", icon: "⚠️" },
];
...
const children = [
  ...
  { name: "Ahmed Mohamed", mother: "Hoda Eslam", status: "None", lastCheck: "30 Minutes Ago", avatar: "A" },
];
              ...
              <tr key={i} className="border-b border-gray-50 hover:bg-gray-50 transition">
                ...
                <td className="px-6 py-3">
                  <span className={`px-2.5 py-1 rounded-full text-xs font-semibold ${statusStyle[child.status]}`}>
                    {child.status === "Verified" && "● "}{child.status === "Pending" && "● "}{child.status}
                  </span>
                </td>
