// src/components/PoliceLayout.jsx
...
const navItems = [
  { label: "Dashboard", icon: "dashboard", path: "/police/dashboard" },
  { label: "Verification Logs", icon: "logs", path: "/police/verification-logs" },
];
...
function SearchModal({ onClose }) {
  ...
  const filters = ["All", "Children", "Verification"];
  return (
  ...
  return (
    <div className="absolute right-0 top-12 w-48 bg-white border border-gray-100 rounded-2xl shadow-xl z-50 overflow-hidden py-1">
      <div className="px-4 py-2 border-b border-gray-100">
        ...
        <p className="text-xs text-blue-500">Police</p>
      </div>
