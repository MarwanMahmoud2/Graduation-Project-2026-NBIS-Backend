...
const icons = {
  ...
  infants: "M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2 M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2 M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2",
...
const navItems = [
  { label: "Dashboard", icon: "dashboard", path: "/nurse/dashboard" },
  { label: "Register Newborn", icon: "register", path: "/nurse/children/register" },
  { label: "Children List", icon: "infants", path: "/nurse/children/list" },
];
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden"
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-100">
          ...
          <input autoFocus value={query} onChange={e => setQuery(e.target.value)}
            ...
            placeholder="Search Children Or Verification..." />
        </div>
  ...
  return (
    <div className="absolute right-0 top-12 w-48 bg-white border border-gray-100 rounded-2xl shadow-xl z-50 overflow-hidden py-1">
      <div className="px-4 py-2 border-b border-gray-100">
        ...
        <p className="text-xs text-blue-500">Nurse</p>
      </div>
